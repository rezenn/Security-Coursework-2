...
export const adminApi = {
  ...
  users: (params?: Record<string, string>) => api.get(API.ADMIN.USERS, { params }).then((r) => r.data),
  ...
  createCourse: (data: Record<string, unknown>) => api.post(API.ADMIN.CREATE_COURSE, data).then((r) => r.data),
  updateCourse: (id: string, data: Record<string, unknown>) => api.patch(API.ADMIN.UPDATE_COURSE(id), data).then((r) => r.data),
  deleteCourse: (id: string) => api.delete(API.ADMIN.DELETE_COURSE(id)).then((r) => r.data),
  addLesson: (id: string, data: Record<string, unknown>) => api.post(API.ADMIN.ADD_LESSON(id), data).then((r) => r.data),
