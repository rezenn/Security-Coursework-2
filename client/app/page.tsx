    ...
    <main className="min-h-screen bg-slate-900">
      ...
      <nav className="border-b border-slate-800">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/register"
              className="btn-primary text-sm h-9 px-4 flex items-center"
            >
              Get started
            </Link>
          </div>
      ...
      <section className="max-w-6xl mx-auto px-6 pt-24 pb-16 text-center">
        ...
        <p className="text-slate-400 text-lg max-w-xl mx-auto mb-10 leading-relaxed">
          ...
          zero-trust security, MFA, and encrypted payments via Stripe.
        </p>
        <div className="flex items-center justify-center gap-4">
          <Link
            href="/register"
            className="btn-primary text-base h-11 px-8 flex items-center gap-2"
          >
            Start learning <Zap size={15} />
          </Link>
          <Link
            href="/login"
            className="btn-secondary text-base h-11 px-8 flex items-center"
          >
            Sign in
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {[
            ...
            },
            {
              ...
              desc: "Pay securely via Stripe. HMAC integrity checks on every transaction. Free courses enrol instantly.",
            },
            {
              icon: Zap,
              color: "emerald",
            ...
            >
              <div
                className={`w-10 h-10 bg-${color}-600/20 rounded-xl flex items-center justify-center mb-4`}
              >
