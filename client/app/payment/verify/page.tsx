...
export default function PaymentVerifyPage() {
  ...
  useEffect(() => {
    // Stripe redirects with payment_intent and redirect_status
    ...
    // Payment is being processed - webhook will handle the completion
    // We just show success and let webhook do the rest
    setStatus("success");
